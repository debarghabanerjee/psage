...
cdef struct hermitian_form_with_character_evaluation :
    int a
    int b1
    int b2
    int c
...
def reduce_GL(s, int D) :
    ...
    """
    cdef hermitian_form_with_character_evaluation res
    cdef int a, b1, b2, c, det_char, nu_char, trans_char
...
cdef hermitian_form_with_character_evaluation _reduce_GL(int a, int b1, int b2, int c, int D) :
    """
